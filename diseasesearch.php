...
<?php endif ?>     </h3>
    ...
    <div>
    <form action="diseasesearch.php" method="post">
    <table><tr><td>
<strong>Enter disease </strogn></td><td><input type="text" name="disease"></td></tr>
<tr><td>
    <strong>Enter Pin Code</strong> </td><td><input type="text" name="pin">
    </td></tr><tr><td>
<input type="submit" name="submit" value="search"></td></tr></table>
</form>
    </div><div>
...
if(isset($_POST["submit"])){
  $disease=$_POST["disease"];
    $pin=$_POST["pin"];
    $query = "SELECT * FROM doctoraccount WHERE disease='$disease' and cpin='$pin'";
