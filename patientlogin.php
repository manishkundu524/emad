...
if (isset($_POST['btn'])) {
  ...
  $query="select * from patientaccount where mobile='$mob' AND pwd='$pwd'";
...
<form name="reg" action="patientlogin.php" method="post" onclick="return validate()">

<table>
<center>
<tr>
<td>Mobile No</td><td><input type="text" name="phone" id="email"></td><td><b id="vmail"></b></td>
</tr>
<tr>
<td>Password</td><td>
...
<table><tr></tr>
<tr>
<td><u><b><font size="4"><a href=patientcreate.php >   Create A New Account </a></font></b></u>
</td></tr>
</tr>
</table>
<div  class ="row">
